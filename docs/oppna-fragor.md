...
- [ ] Färgskalan på kartan: tre steg (1 / 2–3 / 4+) i blått sedan 2026-09-18. Känns enkelresorna för ljusa mot havet, eller ska skalan byta kulör helt? Tonerna ligger som `--v1`/`--v2`/`--v3` per tema i `index.html`. (2026-09-18)
